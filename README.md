...
| CI (locked restore, build, analyzers, format, vulnerable packages, tests, images, Trivy, E2E) | **executed** — [run 35623513605](https://github.com/Gabriel-PereiraL/fullfillmentHub/actions/runs/35623513605) green: 245 tests, images 144/117/130 MB, Trivy 0 HIGH/CRITICAL, E2E 3/3 against the containers |
| Containers and black-box E2E | **executed locally and on GitHub** — E2E 3/3 against the compose stack, Trivy 0 HIGH/CRITICAL (2026-09-21) | [docs/DEPLOYMENT.md §2–§3](docs/DEPLOYMENT.md), [tests/FulfillmentHub.E2ETests](tests/FulfillmentHub.E2ETests) | [.github/workflows/ci.yml](.github/workflows/ci.yml) |
